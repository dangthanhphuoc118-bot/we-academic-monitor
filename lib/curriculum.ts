...
const flyers = units("FLYERS", [
  ...
  { unitNumber: 2, topic: "Going to Town", content: "Vocabulary, writing and communication check", vocabulary: "Expensive - cheap - unhappy - lovely; airport - ambulance - bank - bicycle - bridge - castle - chemist's - corner - factory - fire engine - fire station - front - hill - hotel - middle - money - motorway - museum - police station - post office - pyjamas - railway station - restaurant - sky - skyscraper - stadium - taxi - traffic - university - wood", grammar: "Pattern and freestyle communication", vocabularyMax: 21, writingRef: "" },
  ...
  { unitNumber: 8, topic: "Sports Days", content: "Vocabulary, writing and communication check", vocabulary: "Sore; competition - end - goal - golf - knee - match - prize - race - stadium - snack - team - tennis - volleyball - winner; already - just - yet", grammar: "Pattern and freestyle communication", vocabularyMax: 12, writingRef: "" },
  ...
  { unitNumber: 12, topic: "Past and Future", content: "Vocabulary, writing and communication check", vocabulary: "Enough - ready - worried; air - city - calendar - camel - desert - dinosaur - eagle - environment - forest - future - land - mountain - nest - ocean - octopus - past - planet - pond - pyramid - racing bike - rocket - shell - skyscraper - space - spaceship - stadium - steam - stone - stream - tree", grammar: "Pattern and freestyle communication", vocabularyMax: 23, writingRef: "" },
]);
