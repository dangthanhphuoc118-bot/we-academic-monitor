...
export function CurriculumStudentCheck({ classes, students, curriculum, levelOptions, feedbackOptions, selectedClassId, setSelectedClassId, selectedStudentId, setSelectedStudentId, onSaved, openCurriculum, openFeedbackOptions }: { classes: ClassInfo[]; students: StudentInfo[]; curriculum: CurriculumUnit[]; levelOptions: LevelOption[]; feedbackOptions: FeedbackOption[]; selectedClassId: string; setSelectedClassId: (value: string) => void; selectedStudentId: string; setSelectedStudentId: (value: string) => void; onSaved: () => Promise<void> | void; openCurriculum: () => void; openFeedbackOptions: () => void }) {
  ...
  const resetEvaluation = () => {
    setSpellingPercent(""); setWritingPercent(""); setVocabularyCorrect(""); setCommunicationPercent(""); setPatternPercent(""); setFreestylePercent(""); setPronunciation(""); setNotes(""); setSelectedFeedbackIds([]);
  };
  ...
  const save = async () => {
    ...
    try {
      ...
      await send("createLearningCheck", { studentId: student.id, programCode: program.code, unitNumber: unit.unitNumber, teacherName, checkedAt, evaluation, feedback, notes });
      await onSaved();
