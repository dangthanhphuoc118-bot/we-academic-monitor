...
function CambridgeEvaluationMatrix({ pronunciation, setPronunciation, patternPercent, setPatternPercent, freestylePercent, setFreestylePercent, patternOneOrMany, setPatternOneOrMany, freeOneOrMany, setFreeOneOrMany, patternAmIsAre, setPatternAmIsAre, freeAmIsAre, setFreeAmIsAre }: {
  pronunciation: string; setPronunciation: (value: string) => void;
...
export function CurriculumStudentCheck({ classes, students, curriculum, freestyleBanks, levelOptions, feedbackOptions, selectedClassId, setSelectedClassId, selectedStudentId, setSelectedStudentId, onSaved, openFeedbackOptions, canManage = true, embedded = false, editingCheck = null, initialCheckedAt }: StudentCheckProps) {
  ...
  const [pronunciation, setPronunciation] = useState(String(initialCambridge.pronunciation || initialEvaluation.pronunciation || ""));
  ...
  const resetEvaluation = () => {
    ...
    setSpellingPercent(""); setWritingPercent(""); setVocabularyCorrect(""); setCommunicationPercent(""); setPronunciation(""); setPatternPercent(""); setFreestylePercent(""); setPatternOneOrMany(""); setFreeOneOrMany(""); setPatternAmIsAre(""); setFreeAmIsAre(""); setNotes(""); setSelectedFeedbackIds([]);
  ...
  const cambridgeEvaluation = {
    pronunciation: pronunciation as CambridgePronunciation | "",
    pattern: { oneOrMany: patternOneOrMany as CambridgeBinary | "", amIsAre: patternAmIsAre as CambridgeBinary | "" },
    free: { oneOrMany: freeOneOrMany as CambridgeBinary | "", amIsAre: freeAmIsAre as CambridgeBinary | "" },
  };
  ...
  const save = async () => {
    ...
    const evaluation = program.group === "baby"
      ...
      : program.group === "super"
        ...
        : { patternPercent: Number(patternPercent), freestylePercent: Number(freestylePercent), pronunciation, pattern: cambridgeEvaluation.pattern, free: cambridgeEvaluation.free, freestyleCategory, freestyleQuestions };
